import {
  ...
  REQUEST_LOGIN,RECEIVE_LOGIN,FAILURE_LOGIN,
  RECEIVE_LOGIN_FROM_SESSION,
  REQUEST_BLOGS, RECEIVE_BLOGS, FAILURE_BLOGS,
  REQUEST_LOGOUT,RECEIVE_LOGOUT,FAILURE_LOGOUT,
  REQUEST_LOADING, RECEIVE_LOADING,
  REQUEST_BIRTHDAY,RECEIVE_BIRTHDAY,FAILURE_BIRTHDAY,
  REQUEST_CONTACT_US, RECEIVE_CONTACT_US,FAILURE_CONTACT_US,
  REQUEST_CONTACT_US_POST, RECEIVE_CONTACT_US_POST,FAILURE_CONTACT_US_POST,
  REQUEST_STUDENT_LIST, RECEIVE_STUDENT_LIST,FAILURE_STUDENT_LIST,
  REQUEST_STD_LIST, RECEIVE_STD_LIST,FAILURE_STD_LIST,
  REQUEST_UPDATE_STD_ID,
  RECEIVE_UPDATE_STD_ID,
  REQUEST_COUNT_STUDENT, RECEIVE_COUNT_STUDENT,FAILURE_COUNT_STUDENT,
  REQUEST_COUNT_TEACHER, RECEIVE_COUNT_TEACHER,FAILURE_COUNT_TEACHER,
  REQUEST_COUNT_ADMIN, RECEIVE_COUNT_ADMIN,FAILURE_COUNT_ADMIN,
  REQUEST_COUNT_NONTEACHING, RECEIVE_COUNT_NONTEACHING,FAILURE_COUNT_NONTEACHING,
  REQUEST_POST_MESSAGE, RECEIVE_POST_MESSAGE,FAILURE_POST_MESSAGE,
  REQUEST_PAGE_SETUP,
  REQUEST_ADD_NOTIFI_USER,
  REQUEST_REMOVE_NOTIFI_USER,
  REQUEST_COMMENT_POST, RECEIVE_COMMENT_POST,FAILURE_COMMENT_POST,
  REQUEST_BALANCE, RECEIVE_BALANCE,FAILURE_BALANCE,
  REQUEST_USER_SEARCH, RECEIVE_USER_SEARCH,FAILURE_USER_SEARCH,
  REQUEST_ADD_USER, RECEIVE_ADD_USER,FAILURE_ADD_USER,
  REQUEST_GET_GENDER, RECEIVE_GET_GENDER,FAILURE_GET_GENDER,
  REQUEST_GET_CONTACT_TYPE, RECEIVE_GET_CONTACT_TYPE,FAILURE_GET_CONTACT_TYPE,
  REQUEST_GET_ADDRESS_TYPE, RECEIVE_GET_ADDRESS_TYPE,FAILURE_GET_ADDRESS_TYPE,
  REQUEST_RELATION, RECEIVE_RELATION,FAILURE_RELATION,
  REQUEST_STATES, RECEIVE_STATES,FAILURE_STATES,
  REQUEST_DISTRICTS, RECEIVE_DISTRICTS,FAILURE_DISTRICTS,
  REQUEST_PINS, RECEIVE_PINS,FAILURE_PINS,
  REQUEST_TRANSPORT, RECEIVE_TRANSPORT,FAILURE_TRANSPORT,
  REQUEST_SCHOLOR, RECEIVE_SCHOLOR,FAILURE_SCHOLOR,
  REQUEST_ADD_STUDENT, RECEIVE_ADD_STUDENT,FAILURE_ADD_STUDENT,
  REQUEST_PARENT, RECEIVE_PARENT,FAILURE_PARENT,
  REQUEST_ADD_ADDRESS, RECEIVE_ADD_ADDRESS,FAILURE_ADD_ADDRESS,
  REQUEST_ADD_CONTACT, RECEIVE_ADD_CONTACT,FAILURE_ADD_CONTACT,
  REQUEST_ADD_DOCUMENT, RECEIVE_ADD_DOCUMENT,FAILURE_ADD_DOCUMENT,
  REQUEST_UPDATE_PROGRESS,
  REQUEST_GET_TEACHER, RECEIVE_GET_TEACHER,FAILURE_GET_TEACHER,
  REQUEST_POST_BLOG, RECEIVE_POST_BLOG,FAILURE_POST_BLOG,
  REQUEST_POST_REGISTER, RECEIVE_POST_REGISTER,FAILURE_POST_REGISTER,
  REQUEST_GET_HOLIDAYS, RECEIVE_GET_HOLIDAYS,FAILURE_GET_HOLIDAYS,
  REQUEST_GET_FAQ, RECEIVE_GET_FAQ,FAILURE_GET_FAQ,
  REQUEST_GET_NOTIFICATION, RECEIVE_GET_NOTIFICATION,FAILURE_GET_NOTIFICATION,
  REQUEST_GET_ALUMINI, RECEIVE_GET_ALUMINI,FAILURE_GET_ALUMINI,
  REQUEST_GET_THOUGHT, RECEIVE_GET_THOUGHT,FAILURE_GET_THOUGHT,
  REQUEST_GET_FOOTER, RECEIVE_GET_FOOTER,FAILURE_GET_FOOTER,
  REQUEST_GET_FAQ_TITLE, RECEIVE_GET_FAQ_TITLE,FAILURE_GET_FAQ_TITLE,
